        ...
        <div className={`relative ${clickedAddItem ? "overflow-hidden" : ""} w-full`}>
            ...
            {activatedPopup && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white p-8 w-[350px] md:w-[500px] shadow-lg z-50 flex flex-col">
            ...
            <div className='flex text-4xl font-bold text-white bg-[var(--brand-black)] px-2 py-3'>
                {/* <h1 className='text-6xl'>{Icon}</h1> */}
                <h1 className='text-center my-auto'>Stock</h1>
            </div>

            <div id='item-list' className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-3 xl:grid-cols-5 2xl:grid-cols-6 bg-white py-10 px-5 border-[var(--brand-black)] border-[0.25rem]'>
                ...
                <div id='holder' className='flex flex-col overflow-hidden'>
                    ...
                    <div className='flex justify-center items-center gap-5'>
                        ...
                        <div className='flex py-2'>
                            ...
                            <input type='number' value={stockValue} onChange={handleQuantityChange} className='font-bold border-[var(--brand-black)] border-[0.10rem] px-1 mx-5 w-[50px] text-center'></input>
                        </div>
    ...
    return(
        <div onClick={handleClicked} className={`card grid overflow-hidden ${itemData.data.item_quantity<=0 ? "border-red-500 border-[0.25rem]" : "cardBorder"}`}>
            ...
            <div className='grid'>
                ...
                <label className='border-t-[0.05rem] border-[var(--brand-black)] text-center lg:text-xl'>Stock : <span className='font-medium'>{itemData.data.item_quantity}</span></label>
            </div>
        </div>
    )
}
